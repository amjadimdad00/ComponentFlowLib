...
const SvgShadowNone = (props: SVGProps<SVGSVGElement>): JSX.Element => (
  <svg
  ...
  >
    ...
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M9.024 13.296c1.633-3.458 1.635-8.119.006-11.58l.452-.212c1.692 3.595 1.69 8.412-.005 12.005z"
      clipRule="evenodd"
      opacity={0.25}
    />
    <path
    ...
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M10.331 12.746c1.224-3.225 1.225-7.255.004-10.482l.467-.177c1.265 3.341 1.264 7.497-.004 10.836z"
      clipRule="evenodd"
      opacity={0.35}
    />
    <path
    ...
    <path
      fill="currentColor"
      d="M7.5.877c1.648 0 3.155.604 4.315 1.6l.832-.83a.5.5 0 1 1 .707.707l-.832.83a6.623 6.623 0 0 1-9.337 9.337l-.831.833a.5.5 0 0 1-.707-.707l.83-.832A6.623 6.623 0 0 1 7.499.878M3.857 11.849a5.673 5.673 0 0 0 7.991-7.991zM7.499 1.826A5.674 5.674 0 0 0 1.826 7.5a5.65 5.65 0 0 0 1.325 3.642l7.99-7.99a5.65 5.65 0 0 0-3.642-1.325"
    />
  </svg>
);
